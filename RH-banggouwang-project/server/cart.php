...
if($type == "add"){
    ...
    if(mysqli_num_rows($result) == 0){
        ...
        // ; 
        $sql = "INSERT INTO `bangg`.`cart` (`cart_id`, `id`, `good_id`, `num`) VALUES (null, $id, $good_id, 1)";  
    }else{
        /* 更新数据 */
    ...
    $sql = "SELECT cart.*,list.tlt,list.src,list.shop,list.pro FROM cart , list WHERE cart.good_id = list.id";
