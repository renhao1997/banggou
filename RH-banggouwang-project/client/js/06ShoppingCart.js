$(() => {
    let showText = localStorage.username ? localStorage.username + ",欢迎你！" : "登录";
    $(".log").text(showText);
    ...
    $(".status").click(function () {
        if ($(this).text() == "注销") {
            ...
            window.location.href = "http://127.0.0.1/code/RHproject/client/html/02.registered.html";
        }
    })
    ...
    function renderUI(data) {
        ...
        <ul class="order_lists order_item" gid=${item.good_id}>
            ...
            <li class="list_con">
              ...
              <div class="list_text"><a href="./detail.html?product/${item.good_id}">${item.tlt}</a></div>
            </li>
            <li class="list_price">
              <p class="price">￥${item.pro}</p>
            </li>
            ...
            <li class="list_sum">
              <p class="sum_price" data-price=${item.pro}>￥${Math.round(item.pro * item.num * 100) / 100}</p>
            </li>
            <li class="list_op">
